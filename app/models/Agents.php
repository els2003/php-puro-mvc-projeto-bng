...
class Agents extends BaseModel
{
    ...
    public function check_login($username, $password)
    {
        ...
        // check is a user with that name (username)
    ...
    {
        // get all necesary user data to insert in the session
        $params = [
            ':username' => $username
        ];
        $this->db_connect();
    ...
    {
        // get all clientes from agent with the specified id_agent
        $params = [
            ':id_agent' => $id_agent
        ];
        $this->db_connect();
    ...
    {
        // check if the exists another agent's client with the same name
        $params = [
            ':id' => $id,
            ':name' => $name,
            ':id_agent' => $_SESSION['user']->id
    ...
    {
        // updates the agents client data in the database
        $birthdate = new \Datetime($post_data['text_birthdate']);
        $params = [
            ':id' => $id,
            ':name' => $post_data['text_name'],
